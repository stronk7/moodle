...
class phpunit_coverage_info {
     ...
     * @todo remove in Moodle 4.3 - MDL-xxxx
     */
    ...
    /**
     * Get the formatted XML list of files and folders to includelist.
     *
    ...
    final public function get_includelists(string $plugindir) : array {
        ...
        if (!empty($plugindir)) {
            ...
            // TODO: MDL-xxxxx Remove this whole block once these attributes deprecation period ends.
